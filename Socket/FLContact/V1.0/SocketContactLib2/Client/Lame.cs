...
namespace SocketContactLib.Client
{
    ...
    public class LameWaveFormat
    {
        ...
        public LameWaveFormat(int rate, int bits, int channels)
        {
    ...
    public class Lame
    {
        ...
        [DllImport("Lame_enc.dll", CharSet = CharSet.Ansi, CallingConvention = CallingConvention.Cdecl)]
