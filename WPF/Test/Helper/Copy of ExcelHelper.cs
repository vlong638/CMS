...
//    {
//        static string LogPath = @"F:\工作文档\5.任务\3. 06.05 报文系统\1.津秦正线列控工程数据表-V2.0.6\log.txt";//日志文件
//        OpenFileDialog OFD;
//        HSSFWorkbook workbook;
//        HSSFSheet sheet;
//        HSSFCell cell;
//        //通过起始点 起始列确定rowS rowE columnS 通过属性个数确定columnE
...
//                catch (Exception)
//                {
//                    reportError(string.Format("请检查此{0}文件是否已被打开或被其他应用程序占用", OFD.FileName));
//                    return false;
//                }
//            }
//            else
//            {
//                reportError(string.Format("打开{0}文件出错", OFD.FileName));
//                return false;
//            }
//        }
//        /// <summary>
...
//                        ////中断检索条件 发现空值或非序号字符
//                        //cell = (HSSFCell)row.GetCell(columnS - 1);
//                        //if (cell == null || (cell.ToString().Trim() != startPoint && !int.TryParse(cell.ToString().Trim(), out iParse)))
//                        //{
//                        //    if (!IsStarted)
//                        //    {
//                        //        rowS = index + 1;
